...
const RESULT_PATH = process.env.M3_AB_RESULTS_PATH || "m3-live-ab-results.json";
...
const CASES = [
  {
    ...
    diarization: false,
    asset_sha256: "98e29c2276533699c67454de16b713d9846f668b6cc32b7591a0b2eb8a275a8c",
    reference_transcript_sha256: "2ec614c71321a8747b6bb50fb57a7c341bcad9150a09c5cb2a1825ebfc0f828e"
  },
  {
    case_id: "ru-clean-public-001",
    source_class: "public_web",
    test_dimension: "Russian clean speech",
    ...
    word_timestamps: true,
    diarization: false,
    asset_sha256: "d066239503c4e7406ebeb47423334b5109aa6b30d62046d0338a04e41b4c52f5",
    reference_transcript_sha256: "1c7ac3953951270a56bf5927c86a26d28281ca9b958981c9ab56776837faaadf"
  },
  {
    case_id: "en-clean-public-001",
    source_class: "public_web",
    test_dimension: "English clean speech",
    ...
    word_timestamps: true,
    diarization: false,
    asset_sha256: "63a4b1e4c1dc655ac70961ffbf518acd249df237e5a0152faae9a4a836949715",
    reference_transcript_sha256: "044267656cd78db47edd50fead3ae70f8f7240f3c1f3523cc53b94594de5ecfa"
  }
];
...
function requireSecret(name) {
  ...
  if (!value || !value.trim()) {
    throw new Error(`${name} is not configured for the authorized M3 A/B run.`);
  }
  return value.trim();
}
...
async function main() {
  ...
  const results = {
    schema_version: 1,
    purpose: "KRC MEDIA BETA M3 same-asset prerecorded provider A/B",
  ...
  for (const testCase of CASES) {
    const directory = await mkdtemp(join(tmpdir(), "krc-m3-live-ab-"));
    const caseResult = {
...
main().catch(async (error) => {
  console.error(`M3 live A/B execution failed before completion: ${safeError(error).message}`);
  process.exitCode = 1;
});
